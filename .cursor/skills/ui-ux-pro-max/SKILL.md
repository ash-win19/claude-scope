...
- **Stack**: React + Vite + Tailwind CSS + Radix UI (this project's tech stack)
...
| Stack | Focus |
|-------|-------|
| `react` | React/Next.js performance, components, rendering |
|| `html-tailwind` | HTML + Tailwind CSS responsive layouts, utilities |
...
```bash
python3 .cursor/skills/ui-ux-pro-max/scripts/search.py "component rendering performance" --stack react
```
